pipeline {
  ...
  environment {
    ...
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::748012043774:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-1QE2UB382HKIB'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::748012043774:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-12BQDOZ75RK12'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-1bufoznv22445'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::748012043774:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-ZJFIYAGO6UL6'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::748012043774:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-1BLUGD4F9O1J6'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-1wc9tiw2samjn'
    // If there are functions with "Image" PackageType in your template,
